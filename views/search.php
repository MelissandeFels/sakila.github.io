...
// view to return all films from DB when you make a research
// not really different from ViewHome, both the same
...
<?php
        ...
        echo '<div style="color:white">No result of this search</div>';
    }